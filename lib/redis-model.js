...
let RedisModel = module.exports = function (config, client) {
...
RedisModel.prototype.md5 = function (url) {
  return crypto.createHash('md5').update(url)
    .digest('hex');
};
...
RedisModel.prototype.uniqId = function (callback) {
  this.db.incr(this.kCounter(), function (err, reply) {
    let hash = base58.encode(getRandomInt(9999, 999999) + reply.toString());
